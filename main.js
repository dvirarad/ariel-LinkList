...
const funMessages = [
    ...
    'נבו יקר! אתה חכם כמו חמישה מורים ביחד!',
    'למה המחשב הלך למורה? כי הוא רצה ללמוד אנגלית!',
    'אתה יודע מה? נבו הוא השם הכי יפה שיש!',
    'מה קורה כשאות אלף פוגשת אות בית? הן אומרות אבא!',
    'נבו שלי, אתה גאון! תמשיך ככה!',
    'למה המילה "ספר" אוהבת ללכת לבית הספר? כי שם יש הרבה חברים!',
    'יש לי סוד: אתה הילד הכי מיוחד שיש!',
    'מה עושים כשמילה בורחת? רצים אחריה ותופסים אותה!',
    'נבו הגיבור! אתה יכול לעשות הכל!',
    'למה האלף בית שמחות? כי יש להן חבר טוב בשם נבו!',
    'תאמין לי, אף אחד לא לומד כמוך! אתה אלוף!',
    'מה אומרת אות שמחה? שלום נבו, בוא נשחק!',
    'יופי של יופי! אתה הכי טוב בעולם!',
    'למה האותיות אוהבות את נבו? כי הוא הכי חכם ונחמד!',
    'כל פעם שאתה לומד, האותיות עושות מסיבה!',
    'אתה יודע מי הכי מצחיק? נבו! אתה יודע מי הכי חכם? גם נבו!',
    'למה המילים קופצות משמחה? כי נבו קורא אותן!',
    'סופר סטאר! זה אתה נבו!',
    'מה קורה כששתי אותיות מתחברות? נוצרת מילה של שמחה!',
    'נבו, אתה לא רק חכם, אתה גם מצחיק ונחמד!'
];
